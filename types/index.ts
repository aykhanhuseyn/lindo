...
export type ServiceView = Pick<Service, 'id' | 'name' | 'image' | 'imageOrientation'>
...
type StylistViewPartialStylist = Pick<Stylist, 'id' | 'name' | 'image' | 'rating' | 'ratingCount'>
type StylistViewPartialWorkPlace = Pick<WorkPlace, 'endDate' | 'profession'>
export interface StylistView extends StylistViewPartialStylist, StylistViewPartialWorkPlace {
